...
<table class="tableClass" width="100%" border="0" cellPadding="0" cellspacing="1">
  <form class="formClass" name="myform" action="MenuServlet.html" method="post" target="_blank">
    <tbody>
    <%
    ...
    %>
      <tr>
        ...
        <td class="tdInput" width="35%"><input   name="meet_name" value="<%=p.getMeet_name()%>"></td>
      </tr>
      <tr>
	  <td class="tdLabel" ><span class="required">*</span>
          <label class="label">会议时间：</label></td>
        <td class="tdInput"><input  name="meet_time" value="<%=p.getMeet_time()%>"></td>
        <td class="tdLabel" ><span class="required">*</span>
          <label class="label">会议起草人：</label></td>
        <td class="tdInput" align="left">
		<input   name="pro_name" value="<%=p.getPro_name()%>"/></td>
      </tr>
      <tr>
        <td class="tdLabel" ><span class="required">*</span>
          <label class="label">与会领导：</label></td>
        <td class="tdInput"><input  name="meet_leader" value="<%=p.getMeet_leader()%>">
        <input name="选择1" align="middle" type="image" src="../images/btnChoice.gif"  alt="单击此按钮，选择与会领导" />		</td>
        <td class="tdLabel" ><span class="required">*</span>
          <label class="label">主要参加人员：</label></td>
        <td class="tdInput" align="left">
		<input name="meet_staff"  value="<%=p.getMeet_staff()%>" />
	   ...
	   <tr>
		...
		<input  name="meet_branch" value="<%=p.getMeet_branch()%>"/>
		<input name="选择3" align="middle" type="image" src="../images/btnChoice.gif"  alt="单击此按钮，选择召集部门" /></td>
      </tr>
	   <tr>
        <td class="tdLabel">会议主题：</td>
        <td class="tdInput"><textarea  name="meet_theme"  cols="26" rows="4"  class="textareaClass"><%=p.getMeet_theme()%></textarea></td>
        <td class="tdLabel">会议内容：</td>
        <td class="tdInput"><textarea  name="meet_content"  cols="26" rows="4"  class="textareaClass"><%=p.getMeet_content()%></textarea></td>
      </tr>
    <%}}%>
    </tbody>
  </form>
...
<div class="queryButton">
  <img src="../images/btnSubmit.gif" alt="单击此按钮，提交会议申请" name="查询" border="0" type="image" onclick="myform.submit();"/>
  &nbsp;&nbsp;
  <img src="../images/btnSave.gif" alt="单击此按钮，提交会议申请" name="查询" width="65" height="20" border="0" type="image" onclick="myform.submit();"/>
  &nbsp;&nbsp;
