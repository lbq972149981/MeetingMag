...
<div id="content">
	...
	<!-- 列表主标题div -->
    <div class="mainTitle"><img src="../images/bt1_ico.gif" width="31" height="23" align="absmiddle" />维护会议纪要信息</div>
...
<img name="查询" type="image" src="../images/btnQuery.gif" alt="单击此按钮，根据输入条件查询" />
     ...
     <div class="space"></div>
	  ...
	  <div class=eXtremeTable>	     
		...
		<thead>
		<tr><td class="tableHeader1">选择</td>
		<td nowrap class="tableHeader1" >会议名称</td>
		<td class="tableHeader1" >会议申请人</td>
		...
		%>
			...
			<td>未审批</td>
			<td><a href="CheckMSumServlet.html?id=<%=m.getMsummary_id()%>">查看</a>|<a href="alterMsummary.jsp?id=<%=m.getMsummary_id()%>">编制</a>|<a href="DeleteMSumServlet.html?id=<%=m.getMsummary_id()%>">删除</a></td>
