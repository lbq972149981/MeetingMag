...
<table class="tableClass" width="100%" border="0" cellPadding="0" cellspacing="1">
  <form class="formClass" name="myform" action="AddMSumServlet.html" method="post" target="_blank">
     <tbody>
	 <tr>
...
<div class="queryButton">
    <img onclick="myform.submit();" name="保存" src="../images/btnSave.gif" alt="单击此按钮，保存新增信息">
  &nbsp;&nbsp;
    <a href="../menu.htm"><input name="返回" type="image" src="../images/btnBack.gif"  alt="单击此按钮，返回上一页" /></a>
</div>
<div class="space"></div>
