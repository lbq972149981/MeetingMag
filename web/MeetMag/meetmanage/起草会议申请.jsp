...
function submitaction(){
    document.myform.action="DraftServlet.html?action=submit";
}
function saveaction(){
    document.myform.action="DraftServlet.html?action=save";
}
</script>
</head>
<body>
    ...
    <tbody>
      ...
      <tr>
	   ...
	   <tr>
		...
		<input  id="meet_branch" name="meet_branch" value=""/>
		<input name="选择3" align="middle" type="image" src="../images/btnChoice.gif"  alt="单击此按钮，选择召集部门" /></td>
      </tr>
	   <tr>
        <td class="tdLabel">会议主题：</td>
        <td class="tdInput"><textarea id="meet_theme" name="meet_theme" cols="26" rows="4"  class="textareaClass"></textarea></td>
        <td class="tdLabel">会议内容：</td>
        <td class="tdInput"><textarea id="meet_content" name="meet_content" cols="26" rows="4"  class="textareaClass"></textarea></td>
      </tr>
    </tbody>
  </form>
</table>
...
<div class="queryButton">
  ...
  &nbsp;&nbsp;
  <input name="清空" type="image" src="../images/btnClear.gif"  alt="单击此按钮，清空录入信息" />
  &nbsp;&nbsp;
<a href="defendMapply.jsp"><img src="../images/btnBack.gif" alt="单击此按钮，返回上一页" name="返回" border="0" type="image" /></a></div>
<div class="space"></div>
