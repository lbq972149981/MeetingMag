...
public class DeleteMSumServlet extends HttpServlet{
...
//        String deletesql = "delete from meetsummary_t where msummary_id ='"+id+"'";
        String deletesql = "{call deleteSummary('"+id+"')}";
